 ...
 * Revision: 1.7
 *
 * Last Modified: 23Apr2019
 * Modified by: Keith Hays
 *
 * CHANGE LOG
 *
 * Revision 1.7
 *    - Replaced button images with inline SVG
 *    - Removed aria-hidden attribute from widget and modified to use display:none via javascript.
 *
 * Revision 1.6
